...
import sho from './home_img/sho.jpeg'
...
return (
                ...
                <Row>
                   ...
                   <a href="/post"><Card.Img className="img_card"  variant="top"  src={sho} /></a>
                   <Card.Body>
                       ...
                       <Card.Title>
                           <div className="postall_head">
                               ...
                               <a className="postall_username" href="/profile"><font color="black">{username5}</font></a>
                           </div>
                       </Card.Title>

                       
                       <Card.Text>
                          <a className="postall_topic" href="/post"><font color="black"><b>{topicName2}</b></font></a>
                       </Card.Text>

                       <Card.Text>
                           <div className="postall_price_date">
                          <a className="postall_price"><b>{reward2} บาท</b></a>
                          <a className="postall_date"><b>ต้องการยืมวันที่ {getdate2}</b></a>
                          </div>
                       </Card.Text>
                       </div>
